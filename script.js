...
<aside class="contact-summary reveal" data-reveal="up" aria-label="Контактная информация">
  ...
  <div class="contact-summary__body">
    <section class="contact-summary__section" aria-label="Email">
      ...
      <a class="contact-summary__value contact-summary__value--link" href="mailto:hello@optimaloption.ru">hello@optimaloption.ru</a>
    </section>
    <section class="contact-summary__section" aria-label="Телефон">
      <span class="contact-summary__label">Телефон</span>
      <a class="contact-summary__value contact-summary__value--link" href="tel:+78123898178">+7 812 38-98-178</a>
    </section>
