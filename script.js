(() => {
  ...
  const PAGE_META = {
    ...
    'podtverzhdenie-kompetentnosti-os-smk.html': { title: 'Подтверждение компетентности ОС СМК', family: 'accreditation', serviceScenario: 'Подтверждение компетентности ОС СМК', crumbs: [{ label: 'Главная', href: 'index.html' }, { label: 'Услуги', href: 'uslugi.html' }, { label: 'Аккредитация в ФСА', href: 'akkreditaciya.html' }, { label: 'Подтверждение компетентности ОС СМК' }] },
