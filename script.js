(() => {
  ...
  const PAGE_META = {
    ...
    'dop-uslugi.html': { title: 'Смежные услуги', family: 'adjacent', crumbs: [{ label: 'Главная', href: 'index.html' }, { label: 'Услуги', href: 'uslugi.html' }, { label: 'Смежные услуги' }] },
    'obuchenie-povyshenie-kvalifikacii.html': { title: 'Повышение квалификации', family: 'adjacent', crumbs: [{ label: 'Главная', href: 'index.html' }, { label: 'Услуги', href: 'uslugi.html' }, { label: 'Смежные услуги', href: 'dop-uslugi.html' }, { label: 'Повышение квалификации' }] },
    'profperepodgotovka.html': { title: 'Профпереподготовка', family: 'adjacent', crumbs: [{ label: 'Главная', href: 'index.html' }, { label: 'Услуги', href: 'uslugi.html' }, { label: 'Смежные услуги', href: 'dop-uslugi.html' }, { label: 'Профпереподготовка' }] },
    'okhrana-truda.html': { title: 'Охрана труда', family: 'adjacent', crumbs: [{ label: 'Главная', href: 'index.html' }, { label: 'Услуги', href: 'uslugi.html' }, { label: 'Смежные услуги', href: 'dop-uslugi.html' }, { label: 'Охрана труда' }] },
    'obuchenie-po-okhrane-truda.html': { title: 'Обучение по охране труда', family: 'adjacent', crumbs: [{ label: 'Главная', href: 'index.html' }, { label: 'Услуги', href: 'uslugi.html' }, { label: 'Смежные услуги', href: 'dop-uslugi.html' }, { label: 'Обучение по охране труда' }] },
    'pozharnaya-bezopasnost.html': { title: 'Пожарная безопасность', family: 'adjacent', crumbs: [{ label: 'Главная', href: 'index.html' }, { label: 'Услуги', href: 'uslugi.html' }, { label: 'Смежные услуги', href: 'dop-uslugi.html' }, { label: 'Пожарная безопасность' }] },
    'sout.html': { title: 'СОУТ', family: 'adjacent', crumbs: [{ label: 'Главная', href: 'index.html' }, { label: 'Услуги', href: 'uslugi.html' }, { label: 'Смежные услуги', href: 'dop-uslugi.html' }, { label: 'СОУТ' }] },
